...
Content is authored in this repository and compiled into the application. The desktop app does not yet import content packages at runtime. The bundled catalog contains the Go and Infrastructure Engineering course and four standalone projects.
