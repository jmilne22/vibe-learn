...
- [`.github/workflows/desktop.yml`](.github/workflows/desktop.yml) — builds the desktop installers natively on Windows, macOS, and Linux and uploads them as workflow artifacts.
